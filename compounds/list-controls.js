...
function hideOrShowList(listID){
  ...
  var showList = false;
  if (imgE.getAttribute("src")=="..assets/expand-list-button.png"){showList = true;}
  if (showList == false){
    listE.setAttribute("style","position: absolute; visibility: hidden;");
    imgE.setAttribute("src","..assets/hide-list-button.png");
  }else{
    listE.setAttribute("style","position: static; visibility: visible;");
    imgE.setAttribute("src","..assets/show-list-button.png");
  }
}
